...
```sh
  mkdir newDojo
  cd newDojo
  wget https://github.com/Dojo-Open-Source-Project/samourai-dojo/archive/refs/tags/v1.29.3.tar.gz
  tar xzvf samourai-dojo-v1.29.3.tar.gz
  cp -r samourai-dojo-v1.29.3/* ../
  cd ..
```
- Upgrade
```sh
