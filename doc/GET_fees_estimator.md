...
Returns fees estimated by [Next Block Fee Estimator](https://github.com/Dojo-Open-Source-Project/dojo-tools/packages/next-block-estimator). Fee rates are in satoshi/vByte.
