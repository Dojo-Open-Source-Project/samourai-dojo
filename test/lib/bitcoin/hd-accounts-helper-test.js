...
const XPUB =
	"tpubDDDAe7GgFT4fzEzKwWVA4BWo8fiJXQeGEYDTexzo2w6CK1iDoLPYkpEisXo623ieF79GQ3xpcEVN1vcQhX2sysyL8o1XqzBmQb9JReTxQ7w";
const YPUB =
	"upub5ELkCsSF68UnAZE7zF9CDztvHeBJiAAhwa4VxEFzZ1CfQRbpy93mkBbUZsqYVpoeEHFwY3fGh9bfftH79ZwbhjUEUBAxQj551TMxVyny4UX";
const ZPUB =
	"vpub5ZB1WY7AEp2G1rREpbvpS5zRTcKkenACrgaijd9sw1aYTXR4DoDLNFFcb5o8VjTZdvNkHXFq9oxDZAtfsGMcVy9qLWsNzdtZHBRbtXe87LB";

const POSTMIX_ZPUB =
	"vpub5Y6cjg7GbwSLRu33XB76n3EoJZscmYSVEToLSMqD6ugAcm4rof8E9yvDiaFfhGEuyL95P9VD4A9W3JrBTZhzWSXiRyYvWFnUBAZc67X32wh";
...
describe("HdAccountsHelper", () => {
	...
	describe("deriveAddresses()", () => {
		it("should successfully derive addresses with BIP44", async () => {
			for (const v of BIP44_VECTORS) {
				const addresses = await hdaHelper.deriveAddresses(
					XPUB,
					v[0],
					[v[1]],
					hdaHelper.BIP44,
	...
	describe("xlatXPUB()", () => {
		...
		it("should throw an error on invalid XPUB", () => {
			assert.throws(() => {
				hdaHelper.xlatXPUB(
					"apub6BosfCnifzxcFwrSzQiqu2DBVTshkCXacvNsWGYJVVhhawA7d4R5WSWGFNbi8Aw6ZRc1brxMyWMzG3DSSSSoekkudhUd9yLb6qx39T9nMdj",
				);
			}, errors.xpub.INVALID);
		});
	});
